...
- [x] Update project metadata and version
- [x] Review code for PEP8 compliance and black formatting
- [x] Setup file and manifest checks
- [x] nginx config validation
- [x] Review cli command help texts
- [x] Create changelog for the refactoring
- [x] Update CI/CD configuration if needed (N/A - no CI/CD present)
